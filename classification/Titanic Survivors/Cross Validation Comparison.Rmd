...
ggplot(compare, aes(x=model.name, y=accuracy*100, fill=model.name)) + 
  ...
  theme(axis.text.x = element_blank(), axis.ticks = element_blank(), axis.title.x = element_blank(), legend.title=element_blank()) +
...
Let's compare this performance measure relative to the execution time:
